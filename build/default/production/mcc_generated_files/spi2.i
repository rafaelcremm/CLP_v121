...
SSP2ADD = 0x31;
PIE3bits.SSP2IE = 1;
SPI2_SetInterruptHandler(SPI2_Isr);
TRISDbits.TRISD5 = 0;
...
TRISDbits.TRISD5 = spi2_configuration[spi2UniqueConfiguration].operation;
